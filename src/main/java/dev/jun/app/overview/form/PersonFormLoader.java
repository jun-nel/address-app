package dev.jun.app.overview.form;

import java.io.IOException;

import dev.jun.App;
import dev.jun.core.loader.Loader;
import dev.jun.models.person.Person;
...
public class PersonFormLoader extends Loader {
    ...
    public void load() {
        try {
            ...
            scene.getStylesheets().add(getClass().getResource("/dev/jun/assets/theme/SKIN.CSS")
                    .toExternalForm());
            ...
            formStage.getIcons().add(
                    new Image(getClass()
                            .getResource("/dev/jun/assets/img/favicon.png")
                            .toExternalForm()));
